      ...
      <div className="coin-detail">
        ...
        <div className="coin-price-section">
          <div className="current-price">
            <h2 className="price">
              {formatPrice(coin.market_data.current_price.inr)}
            </h2>
            <span
          ...
          <div className="price-ranges">
            <div className="price-range">
              ...
              <span className="range-value">
                {formatPrice(coin.market_data.high_24h.inr)}
              </span>
            </div>
            <div className="price-range">
              <span className="range-label">24h Low</span>
              <span className="range-value">
                {formatPrice(coin.market_data.low_24h.inr)}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="stats-grid">
          <div className="stat-card">
            ...
            <span className="stat-value">
              {formatMarketCapINR(coin.market_data.market_cap.inr)}
            </span>
          </div>
          <div className="stat-card">
            <span className="stat-label">Volume(24h)</span>
            <span className="stat-value">
              {formatMarketCapINR(coin.market_data.total_volume.inr)}
            </span>
          </div>
          <div className="stat-card">
